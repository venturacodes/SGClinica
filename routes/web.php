...
Route::get('/download_app', 'Web\HomeController@download_app')->name('home.download_app');
Auth::routes();
...
Route::prefix('clinic')->group(function(){
	...
	Route::get('/choose_clinic', 'Web\ClinicController@choose_clinic')->name('clinic.choose_clinic');
});
